      ...
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          new google.maps.marker.AdvancedMarkerElement({
            ...
            map: this.map,
            title: "\u73FE\u5728\u5730",
            content: `<div style="background-color: blue; color: white; padding: 10px; border-radius: 50%; font-size: 16px;">\u{1F4CD}</div>`
          });
          this.findGyms(pos);
        },
        () => {
      ...
      if (status === google.maps.places.PlacesServiceStatus.OK) {
        results.forEach((place) => {
          ...
          new google.maps.marker.AdvancedMarkerElement({
            ...
            map: this.map,
            title: place.name,
            content: `<div style="background-color: green; color: white; padding: 8px; border-radius: 50%; font-size: 18px; display: flex; align-items: center; justify-content: center;">\u{1F3CB}\uFE0F\u200D\u2642\uFE0F</div>`
          });
        });
      } else {
